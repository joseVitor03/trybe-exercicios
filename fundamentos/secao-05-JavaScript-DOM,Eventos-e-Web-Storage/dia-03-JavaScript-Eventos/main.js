...
const exercice2 = (event) => {
    const tech = document.querySelector('.tech');
    tech.classList.remove('tech');
    event.target.classList.add('tech')
    input.value = '';
}
firstLi.addEventListener('click', exercice2)
secondLi.addEventListener('click', exercice2)
thirdLi.addEventListener('click', exercice2)
...
const exercice4 = () => {
    myWebpage.addEventListener('dblclick', () => {
        window.location.replace('https://josevitor03.github.io/')
    })
}
exercice4();
